...
public class ThirdPersonOrbitCam : MonoBehaviour 
{
	...
	void LateUpdate()
	{
		angleH += Mathf.Clamp(InputManager.GetAxis("Mouse X"), -1, 1) * horizontalAimingSpeed * Time.deltaTime;
		angleV += Mathf.Clamp(InputManager.GetAxis("Mouse Y"), -1, 1) * verticalAimingSpeed * Time.deltaTime;
